...
### 哆啦A夢秘密道具機關 Wrap Kit
#### 任意門組
![哆啦A夢秘密道具機關 Wrap Kit](/images/post/Goods/Coroga_Switch/1000135980_1.jpg)
![哆啦A夢秘密道具機關 Wrap Kit](/images/post/Goods/Coroga_Switch/1000135980_2.jpg)
...
### 哆啦A夢秘密道具機關 Jump Kit
#### 空氣砲組
![哆啦A夢秘密道具機關 Jump Kit](/images/post/Goods/Coroga_Switch/1000135981_1.jpg)
![哆啦A夢秘密道具機關 Jump Kit](/images/post/Goods/Coroga_Switch/1000135981_2.jpg)
...
### 哆啦A夢秘密道具機關 Deluxe Kit
#### DX 胖虎組
![哆啦A夢秘密道具機關 Deluxe Kit](/images/post/Goods/Coroga_Switch/1000139048_1.jpg)
![哆啦A夢秘密道具機關 Deluxe Kit](/images/post/Goods/Coroga_Switch/1000139048_2.jpg)
...
+ ひみつ道具スイッチ（`7`種 計`8`pcs）
    ...
    + バイバイン                `x1` 倍倍液 `Jump Kit`
    + 時間ナガナガ光線          `x1` 時間延長光線 `Jump Kit`
    + 空気砲                    `x1` 空氣砲 `Jump Kit`
    + スーパー手ぶくろ          `x2` 超人手套 <mark>NEW</mark>

##### 基本組件
+ その他パーツ（`13`種 計`112`pcs）
    + ブロック                  `x32` 基本塊
    + ハーフブロック            `x16` 半高塊
    + トールブロック            `x16` 高滑塊
    + レールロング              `x4` 長滑軌
    ...
    + 赤ボール                  `x4` 紅球
    + スタートパーツ            `x2` 起點盤
    + ゴール                    `x2` 終點盤 <mark>NEW</mark>
    + ドラえもんゴール          `x1` 哆啦A夢終點盤
    + ミニドラえもんゴール      `x1` 迷你哆啦A夢終點盤

### 哆啦A夢秘密道具機關 Box Stage Kit
![哆啦A夢秘密道具機關 Box Stage Kit](/images/post/Goods/Coroga_Switch/1000145434_1.jpg)
![哆啦A夢秘密道具機關 Box Stage Kit](/images/post/Goods/Coroga_Switch/1000145434_2.jpg)
...
##### 角色機關
+ キャラクタースイッチ（`1`種 計`1`pcs）
    + ジャイアンハンド          `x1` 胖虎拳頭 `Deluxe Kit`

##### 秘密道具機關
+ ひみつ道具スイッチ（`4`種 計`4`pcs）
    + タイムふろしき            `x1` 時光布 <mark>NEW</mark>
    + コエカタマリン            `x1` 聲音凝固劑 <mark>NEW</mark>
    + 空気砲                    `x1` 空氣砲 `Jump Kit`
    + ころばし屋                `x1` 跌倒專家 <mark>NEW</mark>
...
ころがスイッチシリーズ専用の「ころがスイッチ トールブロックセット」が登場！
...
ころがスイッチシリーズ専用の「ころがスイッチ ブロックセット」が登場！
...
![哆啦A夢秘密道具機關 Volume Deluxe Kit](/images/post/Goods/Coroga_Switch/1000149326_2.jpg)
![哆啦A夢秘密道具機關 Volume Deluxe Kit](/images/post/Goods/Coroga_Switch/1000149326_3.jpg)
...
+ 対象年齢：3歳以上
『ドラえもん』より、
「ころがスイッチドラえもん　ボリュームデラックスキット」が登場！

ひみつ道具スイッチとブロックでコースを組んでゴールのドラえもんにボールを届けよう！ボールを転がすとスイッチがアクション！

２階建てのコースがつくれるブリッジブロックが新登場！
ひみつ道具スイッチが全７種入って、コースをつくるためのブロックやレールもたくさん入ったボリューム満点のセットです！
...
##### 秘密道具機關
+ ひみつ道具スイッチ（`7`種 計`8`pcs）
    + タイムふろしき            `x1` 時光布 `Box Stage Kit`
    + バイバイン                `x1` 倍倍液 `Jump Kit`
    + どこでもドア              `x1` 任意門 `Wrap Kit`
    + スーパー手ぶくろ          `x2` 超人手套 `Deluxe Kit`
    + コエカタマリン            `x1` 聲音凝固劑 `Box Stage Kit`
    + タケコプター              `x1` 竹蜻蜓 `Wrap Kit`
    + エスパー帽子              `x1` 超能力帽 `Wrap Kit`

##### 基本組件
+ その他パーツ（`14`種 計`120`pcs）
    + ブロック                  `x32` 基本塊
    + ハーフブロック            `x16` 半高塊
    + トールブロック            `x16` 高滑塊
    + ブリッジブロック          `x8` 橋樑塊 <mark>NEW</mark>
    + カーブレール              `x12` 轉彎軌
    + さかみちレール            `x12` 斜滑軌
    + レール                    `x6` 短滑軌
    + レールロング              `x4` 長滑軌
