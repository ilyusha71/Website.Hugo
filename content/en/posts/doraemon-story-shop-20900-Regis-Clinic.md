...
+ 補充飲品`每款`每天限購`1瓶`。
+ `提神飲料`雖然包裝一樣，但實際上`體力恢復量`分為三種等級，每天`隨機販售`其中一種。
    + 不同等級的提神飲料在庫存空間中會分開堆疊。
...
<table>
    <thead>
        <tr>
            ...
            <td align="center">體力恢復</td>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td align="center">100100</td>
            <td align="center">1104100</td>
...
<table>
    <thead>
        <tr>
            ...
            <td align="center">商品名稱</td>
            <td align="center">販售價格</td>
            <td align="center">最大體力提升</td>
        </tr>
    </thead>
    <tbody>
        <tr>
            <td align="center">100104</td>
            <td align="center">1104140</td>
