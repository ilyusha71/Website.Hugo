---
title: 澆水壺
date: 2020-05-02T20:29:12+08:00
description: 澆水壺的使用方法與效果
draft: false
hideToc: false
enableToc: false
...
categories:
- 哆啦A夢
image: images/post/Season_of_Story/Sprite/icon_1001025.png
---
<mark>最後更新：2020/05/03</mark>

## 澆水壺
+ `澆水壺`無法透過購買取得。
+ `澆水壺`會在`牧場教學`結束後，由`蘭奇`交給`大雄`。
+ `澆水壺`的主要用途為[澆水](../doraemon-story-crop-part4/#澆水)。
+ `澆水壺`的`工具等級`分為`6等`，`Lv.0`至`Lv.5`。
+ `澆水壺`可以在[打鐵店](../doraemon-story-shop-21100-anvil-blacksmith-shop)進行[升級](../doraemon-story-shop-21100-anvil-blacksmith-shop/#升級工具)。
+ `澆水壺`升級後可進行[蓄力](../doraemon-story-tool-watering-can/#澆水壺的蓄力效果)。

### 各等級澆水壺的差異
+ `澆水壺`等級的的主要差異：
    + `儲水量`，`儲水量`的值直接對應滿水時能提供多少作物進行[澆水](../doraemon-story-crop-part4/#澆水)。
    + `最大蓄力段數`
    + `每段蓄力時間`
...
<table>
    ...
    <tr>
        ...
        <td class="breadcrumb">儲水量增加<br>可以使用一段蓄力</td>
    </tr>
    <tr>
        ...
        <td align="center">0.6秒</td>
        <td class="breadcrumb">儲水量增加<br>可以使用二段蓄力</td>
    </tr>
    <tr>
        ...
        <td class="breadcrumb">儲水量增加<br>蓄力時間縮短</td>
    </tr>
    <tr>
        ...
        <td align="center">0.4秒</td>
        <td class="breadcrumb">儲水量增加<br>可以使用三段蓄力</td>
    </tr>
    <tr>
...
+ `澆水壺`的蓄力效果分為`三段`。
+ `蓄力段數`會隨著蓄力持續的時間提升。
+ `蓄力段數`越高消耗的體力越多，但[澆水](../doraemon-story-crop-part4/#澆水)的範圍也越大。
